...
public class StandardnumberAnalyzerProvider extends AbstractIndexAnalyzerProvider<StandardnumberAnalyzer> {
    ...
    public StandardnumberAnalyzerProvider( IndexSettings indexSettings, Environment env,
                                          String name,
                                          Settings settings) {
        super(indexSettings, name, settings);
        this.analyzer = new StandardnumberAnalyzer(new WhitespaceTokenizerFactory(indexSettings, env, name, settings),
                new StandardnumberTokenFilterFactory(indexSettings, env, name, settings),
                new UniqueTokenFilterFactory(indexSettings, env, name, settings));
