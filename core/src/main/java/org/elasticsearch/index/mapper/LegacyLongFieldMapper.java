...
public class LegacyLongFieldMapper extends LegacyNumberFieldMapper {
    ...
    protected void innerParseCreateField(ParseContext context, List<Field> fields) throws IOException {
        ...
        if (context.externalValueSet()) {
            ...
            if (parser.currentToken() == XContentParser.Token.VALUE_NULL ||
                ...
                Extensions.Pair<Long, Float> boostObj = getBoostObjValue(parser, boost);
                Long objValue = boostObj.cur;
                boost = boostObj.cud;
                if (objValue == null) {
                    // no value
                    return;
    ...
    protected Extensions.Pair<Long, Float> getBoostObjValue(XContentParser parser, float boost) throws IOException {
