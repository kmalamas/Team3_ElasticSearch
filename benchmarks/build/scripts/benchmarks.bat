...
set CLASSPATH=%APP_HOME%\lib\elasticsearch-benchmarks-5.0.0-alpha6-SNAPSHOT.jar;%APP_HOME%\lib\elasticsearch-5.0.0-alpha6-SNAPSHOT.jar;%APP_HOME%\lib\jmh-core-1.12.jar;%APP_HOME%\lib\jmh-generator-annprocess-1.12.jar;%APP_HOME%\lib\jopt-simple-4.6.jar;%APP_HOME%\lib\commons-math3-3.2.jar;%APP_HOME%\lib\lucene-core-6.2.0.jar;%APP_HOME%\lib\lucene-analyzers-common-6.2.0.jar;%APP_HOME%\lib\lucene-backward-codecs-6.2.0.jar;%APP_HOME%\lib\lucene-grouping-6.2.0.jar;%APP_HOME%\lib\lucene-highlighter-6.2.0.jar;%APP_HOME%\lib\lucene-join-6.2.0.jar;%APP_HOME%\lib\lucene-memory-6.2.0.jar;%APP_HOME%\lib\lucene-misc-6.2.0.jar;%APP_HOME%\lib\lucene-queries-6.2.0.jar;%APP_HOME%\lib\lucene-queryparser-6.2.0.jar;%APP_HOME%\lib\lucene-sandbox-6.2.0.jar;%APP_HOME%\lib\lucene-spatial-6.2.0.jar;%APP_HOME%\lib\lucene-spatial-extras-6.2.0.jar;%APP_HOME%\lib\lucene-spatial3d-6.2.0.jar;%APP_HOME%\lib\lucene-suggest-6.2.0.jar;%APP_HOME%\lib\securesm-1.1.jar;%APP_HOME%\lib\hppc-0.7.1.jar;%APP_HOME%\lib\joda-time-2.9.4.jar;%APP_HOME%\lib\joda-convert-1.2.jar;%APP_HOME%\lib\snakeyaml-1.15.jar;%APP_HOME%\lib\jackson-core-2.8.1.jar;%APP_HOME%\lib\jackson-dataformat-smile-2.8.1.jar;%APP_HOME%\lib\jackson-dataformat-yaml-2.8.1.jar;%APP_HOME%\lib\jackson-dataformat-cbor-2.8.1.jar;%APP_HOME%\lib\t-digest-3.0.jar;%APP_HOME%\lib\HdrHistogram-2.1.6.jar;%APP_HOME%\lib\spatial4j-0.6.jar;%APP_HOME%\lib\jts-1.13.jar;%APP_HOME%\lib\log4j-api-2.6.2.jar;%APP_HOME%\lib\log4j-core-2.6.2.jar;%APP_HOME%\lib\log4j-1.2-api-2.6.2.jar;%APP_HOME%\lib\jna-4.2.2.jar
